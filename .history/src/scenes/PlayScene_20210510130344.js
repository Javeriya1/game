...
class PlayScene extends  BaseScene {
    ...
    listenToEvents(){
        this.events.on('resume',() => {
          this.initialTime = 3;
          this.countDownText = this.add.text(...this.screenCenter, 'Fly in' + this.initialTime, this.)
        })
    }
    ...
    createScore(){
        ...
        this.bestScoreText = this.add.text(16,50,`Best Score:${bestScore || 0}`,{fontSize:'20px',fill:'#000'}) 
    }
